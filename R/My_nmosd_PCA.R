...
plot1 + plot2
library(ggplot2)
ggsave("/staging/biology/jane0528/NMOSD/scRNA/Dataset/My_merged_protein_coding_genes/My_top10hvg_plot.png", plot = plot1 + plot2, width = 16, height = 8, dpi = 300,bg = "white")
...
ggsave("/staging/biology/jane0528/NMOSD/scRNA/Dataset/My_merged_protein_coding_genes/My_pca_elbow_plot.png", plot = pca_elbow, width = 16, height = 8, dpi = 300,bg = "white")

#----{儲存rds}
saveRDS(merge_data , "/staging/biology/jane0528/NMOSD/scRNA/Dataset/My_merged_protein_coding_genes/My_merged_PCA(protein_coding).rds")
...
#merge_data<-readRDS("/staging/biology/jane0528/NMOSD/scRNA/Dataset/My_merged_protein_coding_genes/My_merged_PCA(protein_coding).rds")
...
#----{保存Seurat物件為H5AD格式}
SeuratDisk::SaveH5Seurat(merge_data_copy , "/staging/biology/jane0528/NMOSD/scRNA/Dataset/My_merged_protein_coding_genes/My_merge_PCA(protein_coding).h5Seurat")

#----{將.h5Seurat 轉換為.h5ad 格式}
SeuratDisk::Convert("/staging/biology/jane0528/NMOSD/scRNA/Dataset/My_merged_protein_coding_genes/My_merge_PCA(protein_coding).h5Seurat", dest = "h5ad")